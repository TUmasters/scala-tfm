...
//
//object LDAParams {
//  val numIterations: Parameter[Int] = Parameter[Int](
//    "num-iterations",
//    """Number of iterations to evaluate LDA for.""",
//    validation = validators.INT_GEQ(1),
//    default = 10
//  )
//
//  val maxAlphaIterations: Parameter[Int] = Parameter[Int](
//    "max-alpha-iterations",
//    """Maximum number of iterations of the Newton-Rhapson method to run to maximize alpha.""",
//    validation = validators.INT_GEQ(1),
//    default = 10
//  )
//}
